// 講義棟 空き状況グリッド
// 夜間スクレイピングで生成される /htmls/lecture-hall.json（部屋×時間帯の構造化データ）を
// 取得し、日付ごとに 10部屋 × 07:00〜22:00 の横棒グリッドで埋まり状況を一目で表示する。
  ...
  return (
    <div className="lh-grid">
      <div className="lecture-hall-controls">
        ...
        />
        <span className="lh-updated">データ更新: {data.updatedAt?.replace('T', ' ') || '不明'}</span>
      </div>
